...
apache::vhost { $::vhost_name:
    ...
    headers            => [
      ...
      "set Content-Security-Policy \"default-src 'none'; frame-ancestors 'none'; connect-src 'self'; font-src 'self'; img-src 'self'; script-src 'self'; style-src 'self'; style-src 'unsafe-inline'\"",
],    
